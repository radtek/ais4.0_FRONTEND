CheckRecordLogNhyyCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'select', 'toastr', 'confirm', '$uibModal', '$timeout', '$filter', 'dateFilter', 'auth'];

module.exports = CheckRecordLogNhyyCtrl;

function CheckRecordLogNhyyCtrl($rootScope, $scope, IHttp, select, toastr, confirm, $uibModal, $timeout, $filter, dateFilter, auth) {
    let vm = this;
    ...
    function initData(isSynchrodata) {
        ...
        IHttp.post('document/searchOptNurseByRegOptId', params).then((rs) => {
            ...
            vm.qxArr = rs.data.instrubillItem;
