...
function monitorConfig($scope, IHttp, $uibModalInstance, items, toastr, $timeout) {
    var promise;
    IHttp.post("operCtl/queryAllMonitorConfig", { regOptId: items.regOptId,docType:2}).then(function(result) {
    ...
    $scope.save = function() {
        ...
        promise = $timeout(function() {
            IHttp.post("operCtl/updMonitorConfig", { regOptId: items.regOptId, checkList: checkList,docType:2 }).then(function(result) {
