devicesstandardconfig.$inject = ['$rootScope', '$scope', 'IHttp', 'uiGridConstants', '$timeout', '$uibModal'];

module.exports = devicesstandardconfig;

function devicesstandardconfig($rootScope, $scope, IHttp, uiGridConstants, $timeout, $uibModal) {
    $scope.params = {
        pageNo: 1,
        pageSize: 15,
        sort: '',
