OperRoomConfigCtrl.$inject = ['$rootScope', '$scope', 'IHttp', 'uiGridConstants', '$timeout', '$uibModal'];

module.exports = OperRoomConfigCtrl;

function OperRoomConfigCtrl($rootScope, $scope, IHttp, uiGridConstants, $timeout, $uibModal) {
    $scope.params = {
        pageNo: 1,
        pageSize: 15,
        sort: '',
